...
import '../../../../core/utils/native_android_util.dart';

class NativeAndroidPage extends StatefulWidget {
  const NativeAndroidPage({super.key});

  @override
  State<NativeAndroidPage> createState() => _NativeAndroidPageState();
}

class _NativeAndroidPageState extends State<NativeAndroidPage> {
  ...
  Future<void> _getBatteryLevel() async {
    ...
    final result = await NativeAndroidUtil.getBatteryLevel();
    setState(() {
  ...
  Future<void> _getDeviceInfo() async {
    ...
    final result = await NativeAndroidUtil.getDeviceInfo();
    setState(() {
      _deviceInfo = result;
  ...
  Future<void> _vibrate() async {
    await NativeAndroidUtil.vibrate(duration: 300);
    if (mounted) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Android Native Method Channel'),
